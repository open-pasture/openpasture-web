# Open Pasture website rebuild handoff

Updated: 2026-09-14. Source: the founder's website discovery interview in this session.

## Purpose

Enable another agent to build a new website grounded in Open Pasture's current
mission, stage, product direction, and business intent. This is the authoritative
positioning handoff for the web repo. It is not a claim that the planned product
exists, a licensing decision, or a completed website redesign.
...
2. [Website brief](website-brief.md): audience, narrative, suggested copy,
...
been ordered; the immediate website job is to help people follow and contribute
to the build.
...
- **Recommended:** site structure, sample copy, and visual choices synthesized
  during discovery. These are a starting point for the next designer, not
  founder-approved final copy or a locked design system.
- **Unresolved:** exact licenses, support infrastructure, social URLs, visual
  assets, and certain public claims. See the build handoff. Do not invent them.
- **Historical implementation:** existing pages and the old project ledger contain
  useful implementation clues but older positioning. Verify their operational
  claims before reusing them.

## What changed

| Earlier website | New direction |
| --- | --- |
...
This documentation update does not modify existing application code, change any
license, publish a site, configure payments, or create a research farm.
